...
PULE_exportFn bool puleShapeIntersectRayTriangle(PuleF32v3 rayOri, PuleF32v3 rayDir, PuleF32v3 tri0, PuleF32v3 tri1, PuleF32v3 tri2, float * distanceNullable, struct PuleF32v2 * uvNullable);
